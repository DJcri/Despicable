...
///
/// Typical usage:
/// var f = new D2HFlow(ctx, rect);
/// Rect a = f.Next(minWidthA);
/// Rect b = f.Next(minWidthB);
///
/// If a rect would exceed the available width, D2HFlow wraps to the next line.
/// </summary>
public sealed class D2HFlow
{
    ...
    public D2HFlow(UIContext ctx, Rect outer, float? lineHeight = null, float? gap = null)
    {
        _ctx = ctx;
        _outer = outer;
        _x = outer.xMin;
